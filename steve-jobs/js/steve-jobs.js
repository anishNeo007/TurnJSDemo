...
function addPage(page, book,src) {
	...
	if (!book.turn('hasPage', page)) {
		...
		var element = $('<div />',
			{'class': 'own-size',
				css: {width: 630 , height: 400}
			}).
			// html(src);
			html('<div class="imageDiv" ><img src='+src+' class="pageImages" /></div>');
		// var element = "<div><img src="+src+" style='width:200px;'  /></div>"
